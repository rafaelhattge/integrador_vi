    ...
    public void salvarUsuario() {
        if (view.getjPasswordSenha().getText().equals(view.getjPasswordSenhaRepete().getText())) {
            ...
            if (view.getjTextNome().getText().equals("")
                ...
                Usuario user = new Usuario(view.getjTextNome().getText().toUpperCase(), view.getjTextEmail().getText(), view.getjTextUser().getText(), view.getjPasswordSenha().getText(),"Estudante","sim");
